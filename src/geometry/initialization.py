...
class TwoFrameInitializer:
    ...
    def initialize(self, kps1, kps2, matches):
        ...
        """
        # Lowered threshold to 15 for sparse or fast initial frames
        if len(matches) < 15:
        ...
        for i, (R_cand, t_cand) in enumerate(candidates):
            ...
            print(f"[DEBUG] Cheirality Candidate {i+1}/4: {num_good} points have positive depth (Z > 0)")
        ...
        # Require at least 15 valid 3D points in front of cameras
        if max_good < 15:
            return False, None, None, None
